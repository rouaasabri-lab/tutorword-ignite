...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "TutorWorld IGCSE Hub is an educational platform offering IGCSE revision resources and quizzes." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "TutorWorld IGCSE Hub is an educational platform offering IGCSE revision resources and quizzes." },
